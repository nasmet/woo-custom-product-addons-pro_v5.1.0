...
//        return $total + ($feeTotal);
    ...
    public
    function add_addon_product_to_cart($cart_item_key)
    {
...
//                    $product_subtotal = wc_price($row_price + $addonPrice * $quantity);
            ...
            $product_subtotal = apply_filters('woocommerce_cart_product_subtotal', $product_subtotal, $_product, $quantity, $this);
        }
